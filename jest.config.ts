...
const config: Config = {
  ...
  coverageThreshold: {
    ...
    'src/lib/sanitize.ts': { statements: 90, branches: 80, functions: 100, lines: 90 },
    'src/lib/validate.ts': { statements: 90, branches: 80, functions: 100, lines: 90 },
    'src/lib/errors/normalize-error.ts': { statements: 90, branches: 85, functions: 100, lines: 90 },
    'src/lib/errors/api-error.ts': { statements: 100, branches: 100, functions: 100, lines: 100 },
  },
};
