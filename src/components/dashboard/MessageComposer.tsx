  ...
  return (
    <Card 
      className={cn(
        ...
        isEditorEmpty ? "h-[200px]" : "min-h-[250px] h-auto max-h-[85vh]"
      )}
    >
      {/* Top Control Bar */}
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button 
                ...
                size="sm" 
                className={cn(
                  "h-9 rounded-xl border-slate-200 bg-white text-slate-600 gap-2 font-bold px-4 hover:bg-slate-50 transition-colors shadow-none",
              ...
              <div className="flex flex-col py-0">
                {groups.map((group, index) => (
                  <button
                    ...
                    className={cn(
                      "w-full text-left px-[12px] py-[5.38px] text-[11.75px] font-normal transition-colors border-b border-[#E2E8F0] last:border-none hover:bg-slate-50 flex items-center whitespace-nowrap",
