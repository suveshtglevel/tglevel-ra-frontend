...
import { getTradeStats, type TradeStats } from '@/components/trade-journal/services/tradeJournals.service';
import type { SubScope } from '@/components/trade-journal/hooks/useAllTradeJournals';
