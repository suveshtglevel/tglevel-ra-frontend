...
import { mapJournalToRow, TradeRow } from '@/components/trade-journal/constants/tradeJournalData';
import { useCommunities } from '@/components/dashboard/hooks/useCommunities';
import { useAllTradeJournals } from '@/components/trade-journal/hooks/useAllTradeJournals';
import { useAllTradeStats } from '@/components/trade-journal/hooks/useAllTradeStats';
