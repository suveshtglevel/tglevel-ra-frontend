...
import { useCommunities } from '@/components/dashboard/hooks/useCommunities';
import { useMessages } from '@/components/dashboard/hooks/useMessages';
import { useMessageTypes } from '@/components/dashboard/hooks/useMessageTypes';
import { useBundles } from '@/components/dashboard/hooks/useBundles';
import { useCreateBundle } from '@/components/dashboard/hooks/useCreateBundle';
import { useDeleteBundle } from '@/components/dashboard/hooks/useDeleteBundle';
import { usePinnedMessages } from '@/components/dashboard/hooks/usePinnedMessages';
import { useSendMessage, type SendTarget } from '@/components/dashboard/hooks/useSendMessage';
import { toCommunityVM } from '@/components/dashboard/services/community.service';
import { togglePinnedMessage } from '@/components/dashboard/services/pinnedMessages.service';
import { getApiErrorMessage } from '@/lib/errors/api-error';
import { mapBackendMessage } from '@/lib/mappers/message';
import type { CommunityVM, BundleVM } from '@/types/dashboard';
import type { SendMessageInput } from '@/components/dashboard/services/messages.service';
