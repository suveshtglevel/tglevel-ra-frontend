...
import CommunitySidebar from '@/components/dashboard/components/CommunitySidebar';
import ChatHeader from '@/components/dashboard/components/ChatHeader';
import PinnedAlert from '@/components/dashboard/components/PinnedAlert';
import ChatFeed from '@/components/dashboard/components/ChatFeed';
import type { ReplyContext } from '@/components/dashboard/components/MessageComposer';
...
const MessageComposer = dynamic(
  () => import('@/components/dashboard/components/MessageComposer'),
  {
    ssr: false,
    loading: () => (
