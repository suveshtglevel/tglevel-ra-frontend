...
import { useTradeJournal } from '@/components/trade-journal/hooks/useTradeJournal';
import { PAGE_SIZE_OPTIONS, type TradeRow } from '@/components/trade-journal/constants/tradeJournalData';
import DateRangePicker from '@/components/trade-journal/components/DateRangePicker';
import FilterDropdown from '@/components/trade-journal/components/FilterDropdown';
import PLFilter from '@/components/trade-journal/components/PLFilter';
import JournalTabs, { type JournalTab } from '@/components/trade-journal/components/JournalTabs';
import CustomerTradeJournal from '@/components/trade-journal/components/CustomerTradeJournal';

// The edit modal only mounts when a row's Edit is clicked — load it on demand.
const EditTradeJournalModal = dynamic(
  () => import('@/components/trade-journal/components/EditTradeJournalModal'),
  { ssr: false }
);
